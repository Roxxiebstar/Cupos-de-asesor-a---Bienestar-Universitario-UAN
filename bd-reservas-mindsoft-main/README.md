# Base de datos · Reserva de cupos de asesoría

Datos del proyecto de **Gestión de Proyectos de Software · UAN · 2026-II**.
Repositorio del equipo **MindSoft**.

| | |
|---|---|
| Recursos | 10 |
| Franjas horarias | 1200 |
| Reservas semilla | 144 |
| Usuarios | 40 |
...
**`recursos`** — lo que se reserva: un profesional de orientación psicosocial o un asesor de lectura y redacción. Los campos `capacidad` y `atributos` describen cada uno.
...
**Regla propia de su dominio:** Cada estudiante puede tener una sola reserva activa por tipo de asesoría (orientación psicosocial y lectura y redacción son tipos distintos).
